...
def test_collaboration_initialization():
    collaboration = Collaboration(id_collaboration=1, id_conversation=10, id_user=100, role="admin")
...
def test_collaboration_equality_with_none_id():
    ...
    collab1 = Collaboration(id_collaboration=None, id_conversation=10, id_user=100, role="admin")
    collab2 = Collaboration(id_collaboration=None, id_conversation=10, id_user=100, role="admin")
    collab3 = Collaboration(id_collaboration=1, id_conversation=10, id_user=100, role="admin")
...
def test_role_with_special_characters():
    ...
    with pytest.raises(ValueError):
        Collaboration(id_collaboration=1, id_conversation=10, id_user=100, role="adm!n")
    with pytest.raises(ValueError):
        Collaboration(id_collaboration=1, id_conversation=10, id_user=100, role="view#er")
    with pytest.raises(ValueError):
        Collaboration(id_collaboration=1, id_conversation=10, id_user=100, role="writ$er")
...
def test_multiple_collaborations_equality():
    ...
    for c1, c2 in zip(collabs1, collabs2, strict=False):
        assert c1 == c2

    for c1, c3 in zip(collabs1, collabs3, strict=False):
        assert c1 != c3
...
def test_collaboration_with_empty_strings_in_ids():
    ...
    with pytest.raises(ValueError):
        Collaboration(id_collaboration="", id_conversation=10, id_user=100, role="admin")
    with pytest.raises(ValueError):
        Collaboration(id_collaboration=1, id_conversation="", id_user=100, role="admin")
    with pytest.raises(ValueError):
        Collaboration(id_collaboration=1, id_conversation=10, id_user="", role="admin")
...
def test_collaboration_with_negative_and_zero_combination():
    ...
    collab = Collaboration(id_collaboration=-1, id_conversation=0, id_user=-100, role="viewer")
    assert collab.id_collaboration == -1
    assert collab.id_conversation == 0
    assert collab.id_user == -100
...
def test_collaboration_with_non_ascii_role():
    ...
    with pytest.raises(ValueError):
        Collaboration(id_collaboration=1, id_conversation=10, id_user=100, role="administrateur")
    with pytest.raises(ValueError):
        Collaboration(id_collaboration=1, id_conversation=10, id_user=100, role="观众")
...
def test_collaboration_with_different_roles():
    ...
    collab1 = Collaboration(id_collaboration=1, id_conversation=10, id_user=100, role="admin")
    collab2 = Collaboration(id_collaboration=1, id_conversation=10, id_user=100, role="viewer")
    assert collab1 != collab2
...
def test_collaboration_with_partial_none_ids():
    ...
    with pytest.raises(ValueError):
        Collaboration(id_collaboration=None, id_conversation=None, id_user=100, role="admin")
    with pytest.raises(ValueError):
        Collaboration(id_collaboration=1, id_conversation=None, id_user=None, role="admin")
